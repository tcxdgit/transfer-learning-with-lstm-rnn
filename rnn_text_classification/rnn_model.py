...
class RNN_Model(object):
    ...
    def __init__(self, config, num_classes, is_training=True):
        ...
        with tf.name_scope("mean_pooling_layer"):
            ...
            out_put = tf.truediv(tf.reduce_sum(out_put, 0), tf.reduce_sum(self.mask_x, 0)[:, None], name="out_pooling")
        ...
        lr_summary = tf.summary.scalar("Learning Rate", self.lr)

        self.summary = tf.summary.merge([loss_summary, accuracy_summary, lr_summary, self.grad_summaries_merged])
